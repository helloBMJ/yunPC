  ...
  <div class="table-list">
    <div class="top-select">
      <el-tabs type="border-card">
        ...
        <el-tab-pane label="报备有效">报备有效</el-tab-pane>
        <el-tab-pane label="报备无效">报备无效</el-tab-pane>
      </el-tabs>
    </div>
  </div>
</template>
